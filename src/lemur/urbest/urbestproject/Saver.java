...
public class Saver {
	...
	public void saveAchievedPoints(Context context, String taskName, float score, String taskColumn){
	...
	public void saveMarkSculptures(Context context, String markerId, LatLng marker, String markerColumn){
